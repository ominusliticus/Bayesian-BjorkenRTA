...
namespace hydro
{
    ...
    struct ViscousHydroEvolution
    {
        ...
        TransportCoefficient CalculateTransportCoefficients(double e, double pi, double Pi, double tau, SP& params);

        // Evolution equations
        double dedt(double e, double pi, double Pi, double tau);
        double dpidt(double e, double pi, double Pi, double tau, TransportCoefficient& tc);
        double dPidt(double e, double pi, double Pi, double tau, TransportCoefficient& tc);
    ...
    struct AnisoHydroEvolution
    {
        ...
        TransportCoefficients CalculateTransportCoefficients(double e, double pt, double pl, double tau, SP& params);
        // Functions used to calcualte the transport coefficients
        double InvertShearToXi(double e, double pi);
